              ...
              <div className="pad-20 overflow-hidden">
                <section className="written-content">
                  ...
                  <p>
                    ...
                    <a href="/terms-of-use">Terms of Use</a> and any other
                ...
                <section className="written-content">
                  ...
                  <ol>
                    <li>
                      ...
                      information about you that you give us by filling in forms
                      on https://car-listing-frontend-peach.vercel.app (our
                      site) or by corresponding with us by phone, e-mail or
                      otherwise. It includes information you provide when you
                      register to use our site, subscribe to our service, search
                      for a product, place an order on our site, participate in
                      discussion boards or other social media functions on our
                      site, enter a competition, promotion or survey, and when
                      you report a problem with our site. The information you
                      give us may include your name, address, e-mail address and
                      phone number, financial and credit card information,
                      personal description and photograph, date of birth,
                      employment details, and address history.
                    </li>
                    <li className="written-content">
                      <p>
                        <strong>Information we collect about you.</strong> With
                        regard to each of your visits to our site we will
                      ...
                      <ul className="bullets">
                        ...
                        <li>
                          ...
                          through and from our site (including date and time),
                          products you viewed or searched for, page response
                          times, download errors, length of visits to certain
                    ...
                    <li>
                      ...
                      This is information we receive about you if you use any of
                      the other websites we operate or the other services we
                      provide. In this case we will have informed you when we
                      collected that data if we intend to share those data
                      internally and combine it with data collected on this
                      site. We will also have told you for what purpose we will
                      share and combine your data. We are working closely with
                      third parties (including, for example, business partners,
                      sub-contractors in technical, payment and delivery
                      services, advertising networks, analytics providers,
                      search information providers, credit reference agencies).
                      We will notify you when we receive information about you
                ...
                <section className="written-content">
                  ...
                  <ol>
                    <li className="written-content">
                      ...
                      <ul className="bullets">
                        ...
                        <li>
                          ...
                          contact you by electronic means (email or SMS) if you
                        ...
                        <li>
                          ...
                          the most effective manner for you and for your device.{" "}
                        </li>
                      </ul>
                    </li>
                    <li className="written-content">
                      <p>
                        <strong>Information we collect about you.</strong> We
                      ...
                      <ul className="bullets">
                        ...
                        <li>
                          {" "}
                          as part of our efforts to keep our site safe and
                          secure;{" "}
                        </li>
                        <li>
                          {" "}
                        ...
                        <li>
                          ...
                          other users of our site about goods or services that
                    ...
                    <li>
                      ...
                      We will combine this information with information you give
                      to us and information we collect about you. We will use
                      this information and the combined information for the
                      purposes set out above (depending on the types of
                  ...
                  <ol>
                    ...
                    <li className="written-content">
                      ...
                      <ul className="bullets">
                        <li>
                          {" "}
                          any of our business partners, suppliers and
                          sub-contractors (AQL Text Credits, AutoTrader,
                          Barclays, Bing, Book my Garage, Canddi, Chat Heroes,
                          Click Dealer, Click Desk, Codeweavers, Conflux,
                          Contact at Once, CreditPlus, DealTrak, Evolution
                          Funding Ltd, General Insurance Distribution Ltd, Good
                          Garage Scheme, Google, Heart Internet, iVendi, Judge
                          Service, Live Chat Inc, Live Help Now, MailChimp,
                          Mandrill, Mapfre, Motor Marketing, Oodle Finance,
                          PayPal, Review.io, Sage, Stripe, Trello, Trust Pilot,
                          Twilio, UK Fast, Visitor Chat, WorldPay, Xero, Yell)
                          where this is necessary for the performance of any
                        ...
                        <li>
                          ...
                          your credit score where this is a condition of us or
                          any of our business partners, suppliers and
                          sub-contractors entering into a contract with you;{" "}
                        </li>
                        <li>
                          finance brokers and lenders for the purpose of
                    ...
                    <p>
                      {" "}
                      We will disclose your personal information to third
                      parties:{" "}
                    </p>
                    <ul className="bullets">
                      <li>
                    ...
                    <p>
                      ...
                      parties to enable them to contact you for marketing
                ...
                <section className="written-content">
                  ...
                  <p>
                    ...
                    SSL technology. Where we have given you (or where you have
                    chosen) a password which enables you to access certain parts
                    of our site, you are responsible for keeping this password
                  ...
                  <p>
                    ...
                    ("EEA") by one of our suppliers. It may also be processed by
                    staff operating outside the EEA who work for one of our
                    suppliers. This includes staff engaged in, among other
                  ...
                  <p>
                    {" "}
                    Unless required to do so by law (eg for the purposes of
                    preventing fraud or tax evasion), we do not retain personal
                    data no longer than is necessary for the purposes for which
                    we originally collected it. Ordinarily, this will be for a
                    period of 7 years if you have purchased a vehicle or
                    services or obtained finance through us, or 6 months if you
                    have not. If you have not objected to our providing you with
                    information about other goods and services we offer that are
                    similar to those that you have already purchased or enquired
                    about, or if you have given and not withdrawn your consent
                    for us to use your personal data for other marketing
                    purposes, we will retain the data for as long as we need it
                    for those purposes.{" "}
                  </p>
                  <p>
                    {" "}
                    We regularly review the personal data we hold, and delete
                    anything we no longer need. Information that does not need
                    to be accessed regularly, but which still needs to be
                    retained, is safely archived or put offline.{" "}
                  </p>
                </section>
                <section className="written-content">
                  <h3>Your rights</h3>
                  <p>
                    ...
                    data for marketing purposes. We will ask your consent
                  ...
                  <p>
                    ...
                    not checking certain boxes on the forms we use to collect
                    your data. You also have the right to have inaccurate or
                    incomplete data corrected and, in some cases (such as where
                    it is no longer necessary for us to retain the data for the
                    purposes for which it was originally collected/processed,
                    where we need your consent and you have withdrawn such
                    consent, or where you object to the processing and there is
                    no overriding legitimate interest for us to continue with
                    it) to have your personal data removed from our systems.{" "}
                  </p>
                  <p>
                    {" "}
                    Where you have provided your personal data to us and our
                    processing is carried out by automated means based on your
                    consent or for the performance of a contract, you may ask us
                    to provide you with the data in a structured, commonly used
                    and machine readable form or, if this is technically
                    feasible with our systems, to transmit the data directly to
                    another organisation. Machine readable means that the
                    information is structured so that software can extract
                    specific elements of the data.{" "}
                  </p>
                  <p>
                    {" "}
                    Unless the decision is necessary for entering into or for
                    the performance of a contract between us, is authorised by
                    law (eg for the purposes of preventing fraud or tax evasion)
                    or you have given your explicit consent for us to do so, you
                    have the right to ask us not to subject you to any decision
                    which produces a legal effect or a similarly significant
                    effect on you on the basis of automated processing.{" "}
                  </p>
                  <p>
                    {" "}
                ...
                <section className="written-content">
                  ...
                  <p>
                    ...
                    with the Act. We will not charge you for providing you with
                    details of the information we hold about you unless your
                    request is manifestly unfounded or excessive, particularly
                    if it is repetitive, when we will charge you a reasonable
                    fee, based on the administrative cost of providing the
                    information. We may also charge a reasonable fee to comply
                    with multiple requests for further copies of the same
                    information.{" "}
                  </p>
                </section>
                <section className="written-content">
                  ...
                  <p>
                    ...
                    be posted on this page and, where appropriate, notified to
                    you by e-mail. Please check back frequently to see any
                    updates or change to our privacy policy.{" "}
                  </p>
                </section>
                <section className="written-content">
                  <h3>Contact</h3>
                ...
                <section className="written-content">
                  ...
                  <p>
                    ...
                    Commissioner's Office by writing to it at Wycliffe House,
                    Water Lane, Wilmslow, Cheshire, SK9 5AF, telephoning 0303
                    123 1113 or 01625 545745, sending a fax to 01625 524510, or
                    by completing the online email message form at{" "}
                    <a
