            ...
            favorites.map(async (fav) => {
              try {
                const result = await dispatch(
                  fetchVehicleById(fav.id)
                ).unwrap();
                return result;
              } catch (error) {
                console.error(
                  `Failed to fetch details for vehicle ${fav.id}:`,
                  error
                );
                // Return the original favorite data as fallback
                return fav;
              }
            })
          );
          ...
          <div className="wrapper">
            <div className="container">
              ...
              <div className="favourites-panel">
                <div className="favourites-panel__wrapper flex flex-wrap justify-center lg:justify-start">
                  {loading ? (
                    <div
                    ...
                    enrichedVehicles.map((vehicle, index) => {
                      ...
                      return (
                        <div
                          ...
                          className="vehicle-listing w-full max-w-sm mx-auto lg:mx-5 lg:flex-none lg:w-1/3"
                        >
                          ...
                          <div className="vehicle-listing__button-block">
                            ...
                            <div className="engage-cta">
                              <Link
                                to="/contact"
                                className="button button-engage"
                              >
                                Secure Now
                              </Link>
                            </div>
                    ...
                    >
                      ...
                      <p style={{ color: "#888", marginBottom: "30px" }}>
                        Add vehicles to your favorites to compare them side by
                        side.
                      </p>
                      <Link
                        to="/used-cars"
